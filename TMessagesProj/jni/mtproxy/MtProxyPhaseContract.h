...
constexpr const char *FaketlsNotMtproxyResponse = "faketls_not_mtproxy_response";
constexpr const char *FaketlsNoServerHelloTerminal = "faketls_no_server_hello_terminal";
constexpr const char *FaketlsServerClosedTerminal = "faketls_server_closed_terminal";
